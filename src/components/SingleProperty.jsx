...
const SingleProperty = ({ property, realtor }) => {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
            ...
            <div className='mt-4 lg:mt-0'>
              <div className='text-3xl font-bold text-blue-600 flex items-center'>
                ...
                {property?.property_price > 0
                  ? Intl.NumberFormat('en-US').format(property.property_price)
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white rounded-2xl shadow-lg p-6 sticky top-24'>
              ...
              <div className='space-y-4'>
                <button
                  onClick={() => navigate(`/lease-property/${property?.id}`)}
            ...
            <div className='bg-white rounded-2xl shadow-lg p-6'>
              ...
              <div className='flex items-center space-x-4 mb-4'>
                <div className='w-16 h-16 bg-gradient-to-r from-blue-500 to-orange-500 rounded-full flex items-center justify-center text-white text-xl font-bold'>
                  {property?.user?.first_name?.[0]}
                  {property?.user?.last_name?.[0]}
                </div>
                <div>
      ...
      {realtor ? (
        <TenancyRequestsTable requests={property?.tenancyRequests} />
      ) : null}
    </div>
  );
};
